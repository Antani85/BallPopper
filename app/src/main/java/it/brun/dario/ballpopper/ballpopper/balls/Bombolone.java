 ...
 */
public class Bombolone extends Bomba
{


    public Bombolone(Ambiente a, float ix, float iy, int c, float xx, float yy)
    {
    ...
    public Bombolone(Ambiente a,float ix,float iy, int c,float xx,float yy,Bonus bon)
    {
    ...
    {
        return new Bombolone(a,ix,iy,c,xx,yy,getBonus());
