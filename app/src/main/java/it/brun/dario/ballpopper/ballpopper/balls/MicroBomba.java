 ...
 */
public class MicroBomba extends Bomba
{


    public MicroBomba(Ambiente a, float ix, float iy, int c, float xx, float yy)
    {
    ...
    public MicroBomba(Ambiente a,float ix,float iy, int c,float xx,float yy,Bonus bon)
    {
    ...
    {
        return new MicroBomba(a,ix,iy,c,xx,yy,getBonus());
