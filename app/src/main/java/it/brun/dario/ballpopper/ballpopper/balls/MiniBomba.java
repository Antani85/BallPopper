 ...
 */
public class MiniBomba extends Bomba
{


    public MiniBomba(Ambiente a, float ix, float iy, int c, float xx, float yy)
    {
    ...
    public MiniBomba(Ambiente a,float ix,float iy, int c,float xx,float yy,Bonus bon)
    {
    ...
    {
        return new MiniBomba(a,ix,iy,c,xx,yy,getBonus());
